...
GraphQL is a query language and runtime for APIs that allows clients to request exactly the data they need. This implementation guide covers Hot Chocolate, the most popular GraphQL server for .NET.
